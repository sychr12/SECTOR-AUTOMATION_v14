...
class AnexarUI(ctk.CTkFrame):
    ...
    def _build_barra_acao(self, parent):
        ...
        # Separador
        sep = ctk.CTkFrame(bar, width=1, height=32, fg_color=_CINZA_BORDER)
        ...
        # Search Bar
        self._search_frame = ctk.CTkFrame(bar, fg_color=_BRANCO, corner_radius=10,
                                          border_width=1, border_color=_CINZA_BORDER)
        self._search_frame.pack(side="right", padx=(20, 0))
        ...
        self._search_entry.bind("<KeyRelease>", lambda e: self._on_search(self._search_entry.get()))
    ...
    def _build_notebook(self, parent):
        ...
        self.lista_cart, c1 = CarteirasTable.criar(aba_carteiras, self._baixar_pdf)
    ...
    def _recarregar(self):
        ...
        def _worker():
            try:
                ...
                self.after(0, CarteirasTable.carregar, self.lista_cart, rows, self._baixar_pdf)
    ...
    def _on_search(self, query):
        ...
        def _worker():
            try:
                ...
                self.after(0, CarteirasTable.carregar, self.lista_cart,
                           filtrados, self._baixar_pdf)
                self.after(0, self._lbl_db.configure,
    ...
    def _set_status(self, texto, tipo="info"):
        ...
        cores = {"primary": _ACCENT, "success": _VERDE_STATUS,
                 "error": _VERMELHO, "warning": _AMARELO, "info": _MUTED}
    ...
    def _iniciar(self):
        ...
        threading.Thread(target=self.controller.executar_processamento,
                         daemon=True).start()
